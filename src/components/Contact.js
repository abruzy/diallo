      ...
      <div className="grid lg:grid-cols-7 gap-y-6 lg:max-w-6xl mx-auto">
        ...
        <form className="lg:col-span-4">
          <div className="grid lg:grid-cols-2 col-gap-4 row-gap-4">
            <input type="text" className="border-2 p-2 rounded focus:border-normal-green focus:border w-full" placeholder="First Name" />
            <input type="text" className="border-2 p-2 rounded focus:border-normal-green focus:border w-full" placeholder="Last Name" />
            <input type="email" className="border-2 p-2 rounded col-span-2 focus:border-normal-green focus:border w-full" placeholder="Email address" />
